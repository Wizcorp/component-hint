	...
	loadData(absolutePath, function (error, componentData) {
		...
		async.series([
			function (callback) {
				...
				checkLocalPaths(absolutePath, componentData, options, function (lintErrors, resolvedDeps) {
			...
			function (callback) {
				// Lint dependencies
				checkDependencies(absolutePath, componentData, options, function (lintErrors, resolvedDeps) {
