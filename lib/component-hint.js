	...
	loadData(absolutePath, function (error, componentData) {
		...
		async.series([
			function (callback) {
				...
				checkLocalPaths(absolutePath, componentData, options, function (error, lintErrors, resolvedDeps) {
			...
			function (callback) {
				// Lint dependencies
				checkDependencies(absolutePath, componentData, options, function (error, lintErrors, resolvedDeps) {
